$(document).ready(function() {
  ...
  function showQuestion() {
    ...
    $form2.append("<div id = hypCheck>Hypotenuse: <span class = 'fup my-1'><input class = 'hyp' type = 'numeric' pattern='\d*' maxlength = '2' size = '2'></input></span></div>");
    $("#showSides").html($form2)

    $form = $("<form autocomplete = 'off'></form>");
    $form.addClass("guessForm1 fraction ml-0 mt-2");
    $form.append("<span class = 'fup'><input class = 'first' type = 'numeric' pattern='\d*' maxlength = '2' size = '2'></input></span>");
    $form.append("<span class = 'bar my-3'></span>")
    // $form2 = $("<form autocomplete = 'off'></form>");
    // $form2.addClass("guessForm2 fraction ml-0 mt-2");
    $form.append("<span class = 'fdn'><input class = 'second' type = 'numeric' pattern='\d*' maxlength = '2' size = '2'></input></span>");
    ...
    $(".secSubmit").on("click", function() {
      ...
      for (var i = 0; i < trigButtons.length; i++) {
        ...
        $(".sinCosTan").on("click", function() {
          ...
          $form3.append("<span class = 'angle'><input class = 'angleInput' type = 'numeric' pattern='\d*' maxlength = '2' size = '2'></input></span>");

          $form4 = $("<form autocomplete = 'off'></form>");
          $form4.addClass("guessForm4 fraction ml-0 mt-2");
          $form4.append("<span class = 'fup'><input class = 'userNumerator' type = 'numeric' pattern='\d*' maxlength = '2' size = '2'></input></span>");
          $form4.append("<span class = 'bar my-3'></span>")
          $form4.append("<span class = 'fdn'><input class = 'userDenominator' type = 'numeric' pattern='\d*' maxlength = '2' size = '2'></input></span>");
